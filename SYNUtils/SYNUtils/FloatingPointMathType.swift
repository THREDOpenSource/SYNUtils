...
public protocol FloatingPointMathType {
    ...
    var exp: Self {get}
    var exp2: Self {get}
    func lerp(a: Self, b: Self, t: Self) -> Self
    var log: Self {get}
    var log10: Self {get}
    var log2: Self {get}
...
extension CGFloat: FloatingPointMathType {
    ...
    public func lerp(a: CGFloat, b: CGFloat, t: CGFloat) -> CGFloat { return a + (b - a) * t }
...
extension Float: FloatingPointMathType {
    ...
    public func lerp(a: Float, b: Float, t: Float) -> Float { return a + (b - a) * t }
...
extension Double: FloatingPointMathType {
    ...
    public func lerp(a: Double, b: Double, t: Double) -> Double { return a + (b - a) * t }
